...
Darwin:
	g++ -std=c++11 -stdlib=libc++ -mmacosx-version-min=10.7 -O3 -shared -I $$NODE/include -fPIC -DLIBUV_BACKEND src/addon.cpp src/lws.cpp -undefined dynamic_lookup /usr/local/lib/libwebsockets.a  -o dist/lws_darwin_`$$NODE/bin/node -e "console.log(process.versions.modules)"`.node
